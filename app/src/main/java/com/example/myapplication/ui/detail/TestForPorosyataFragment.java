...
public class TestForPorosyataFragment extends Fragment {

    private FragmentTestForPorosyataBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentTestForPorosyataBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        binding.ivArr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(TestForPorosyataFragment.this).navigateUp();
            }
        });
