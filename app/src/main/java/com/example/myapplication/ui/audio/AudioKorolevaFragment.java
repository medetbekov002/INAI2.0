...
import com.example.myapplication.databinding.FragmentAudioKorolevaBinding;


public class AudioKorolevaFragment extends Fragment {
    private FragmentAudioKorolevaBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentAudioKorolevaBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.ivArrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavHostFragment.findNavController(AudioKorolevaFragment.this)
                        .navigate(R.id.detailKorolevaFragment);
            }
        });
