...
import com.example.myapplication.databinding.FragmentAudioKolobokBinding;


public class AudioKolobokFragment extends Fragment {

    private FragmentAudioKolobokBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentAudioKolobokBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(getContext(), R.raw.kolobok);
        ...
        binding.ivArrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavHostFragment.findNavController(AudioKolobokFragment.this)
                        .navigate(R.id.detailKolobokFragment);
            }
        });
